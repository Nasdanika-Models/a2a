package org.nasdanika.models.a2a.generator.tests;
...
import org.nasdanika.models.a2a.processors.EcoreGenA2aProcessorsFactory;
 ...
 *
 */
public class TestA2aModelDocGen {
	
	@Test
	public void testGenerateA2alModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenA2aProcessorsFactory ecoreGenA2aProcessorFactory = new EcoreGenA2aProcessorsFactory(context);		
		EcoreNodeProcessorFactory ecoreNodeProcessorFactory = new EcoreNodeProcessorFactory(
				...
				diagnosticConsumer,
				ecoreGenA2aProcessorFactory);
				
		File actionModelsDir = new File("target\\action-models\\");
		actionModelsDir.mkdirs();		
		File output = new File(actionModelsDir, "a2a.xmi");
		...
		String siteMapDomain = "https://a2a.models.nasdanika.org";		
